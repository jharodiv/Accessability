    ...
    return Scaffold(
            ...
            actions: [
              TextButton(
                ...
                child: Text(
                  'Save'.tr(),
                  style: TextStyle(
                    color: _canSave ? _purple : _purple.withOpacity(0.35),
      ...
      body: Column(
        children: [
          Container(
            color: isDarkMode ? Colors.grey[900] : Colors.white,
            // changed height from 0.25 to 0.15 as requested
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(color: _purple.withOpacity(0.35)),
                isDense: true,
                // added horizontal padding and kept vertical spacing
                contentPadding:
                    const EdgeInsets.symmetric(horizontal: 16.0, vertical: 8.0),
                enabledBorder: UnderlineInputBorder(
                  borderSide:
                      BorderSide(color: _purple.withOpacity(0.35), width: 1.2),
                ),
          ...
          Expanded(
            child: Container(
              color:
                  isDarkMode ? theme.scaffoldBackgroundColor : Colors.grey[100],
            ),
          ),
        ],
      ),
